<template>
  <div id="interfaceEchart" style="width: 100%; height: 420px"></div>
</template>

<script setup>
import { onMounted, ref } from "vue";
import echarts from "@/echart";
import { queryInvokeDetailByUserId } from "@/api/userinterfaceinfo";
...
const getInvokeDetail = () => {
  queryInvokeDetailByUserId(userStore.userId).then((res) => {
